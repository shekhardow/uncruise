                                                ...
                                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                    ...
                                                    <tr>
                                                        <td class="table-td new-checkbox-class">
                                                            <div class="checkbox-area">
                                                                <label class="inline-flex items-center cursor-pointer">
                                                                    ...
                                                                    <span class="h-4 w-4 border flex-none border-slate-100 dark:border-slate-800 rounded inline-flex ltr:mr-3 rtl:ml-3 relative transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                                        <img src="<?php echo url('public/assets/images/icon/ck-white.svg'); ?>" alt="" class="h-[10px] w-[10px] block m-auto opacity-0">
                                                                    </span>
                                                                    <span class="text-slate-500 dark:text-slate-400 text-sm leading-6"></span>
                                                                </label>
                                                              </div>
                                                        ...
                                                        <td class="table-td smallText">
                                                         ...
                                                         <td class="table-td smallText">
                                                            <div>
                                                                <?php if($user->reviewcount){ ?>
                                                                    <iconify-icon icon="mdi:tick-circle" style="color: green;" width="25" height="25"></iconify-icon>
                                                                <?php }else{?>
                                                                    <iconify-icon icon="mdi:close-circle" style="color: red;" width="25" height="25"></iconify-icon>
                                                                <?php } ?>
                                                            </div>
                                                        </td>
                                                        <td class="table-td">
                                                            ...
                                                            <div class="customSwitchBox">
                                                                <input type="checkbox" class="toggleStatus"  <?php echo @($user->status=='Active')?"Checked":"" ?> id="customSwitch_<?php echo $i; ?>" data-table="users" data-changevalue="<?php echo @$change_to; ?>" data-column_name='status' data-wherecolumn="user_id" data-wherevalue="<?php echo @$user->user_id; ?>" data-url="<?php echo route('toggleStatus'); ?>"  name="customSwitch" value="<?php echo @$user->status; ?>"/>
