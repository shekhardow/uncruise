                    ...
                    <div class="space-y-5">
                        <div class="card">
                            <div class="card-body p-6">
                                <form method="post" id="submit-form" action="<?php echo !empty($adventure_detail) ? route('admin/updateActivity', ['id' => encryptionID($adventure_detail->activity_id)]) : route('admin/addActivity'); ?>" enctype="multipart/form-data">
                                    <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5 mb-3">
                                        <div class="form-group input-area">
                                            <label for="activity_name" class="form-label">Activity Name :</label>
                                            <input type="text" name="activity_name" id="activity_name" value="<?php echo !empty($adventure_detail->activity_name) ? $adventure_detail->activity_name : null; ?>" class="form-control">
                                        </div>
                                        ...
                                        <div class="multiFilePreview_favicon">
                                            ...
                                            <div id="oldfile">
                                                ...
                                                <div class="relative inline-block">
                                                    ...
                                                    <a href="<?php echo route('admin/deleteActivity', ['id' => encryptionID($value->id)]); ?>" class="delete-image absolute top-0 right-0 p-1 rounded-full bg-red-500 text-white">X</a>
                                                </div>
                                                <?php } ?>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <div class="flex items-center justify-end p-6 space-x-2 border-slate-200 rounded-b dark:border-slate-600">
                                        <a href="<?php echo route('admin/activities'); ?>" class="btn inline-flex justify-center btn-outline-dark">Cancel</a>
