                                        ...
                                        <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5 mb-3">
                                            <div class="form-group input-area">
                                                <label for="multiSelect" class="form-label">Adventures:</label>
                                                    ...
                                                    <?php if($adventures->isNotEmpty()){ foreach($adventures as $adventure){ ?>
                                                                <option  value="<?php echo @$adventure->adventure_id;  ?>" <?php echo (@in_array(@$adventure->adventure_id,$seleted_adventures))?"selected":""; ?> class=" inline-block font-Inter font-normal text-sm text-slate-600"><?php echo @$adventure->journey ?></option>
                                                        <?php }} ?>
                                                </select>
                                            </div>
                                        </div>
