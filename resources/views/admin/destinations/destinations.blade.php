                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-td">
                                                            <?php if($destination->status == 'Active'){ 
                                                                $class = "text-success-500 bg-success-500"; $status = "Active"; $change_to = "Inactive"; 
                                                             }else{  $class = "text-danger-500 bg-danger-500"; $status = "Inactive"; $change_to = "Active"; } ?>
                                                            <!--<a href="<?php // echo url('admin/change-status/' . $destination->destination_id . '/' . $change_to . '/destinations/destination_id/status'); ?>" status-type="<?php // echo $change_to; ?>"class="status inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 <?php //echo $class; ?>">-->
                                                            <!--    <?php //echo $status ?>-->
                                                            <!--</a>-->
                                                            <div class="customSwitchBox">
                                                                <input type="checkbox" class="toggleStatus"  <?php echo @($destination->status=='Active')?"Checked":"" ?> id="customSwitch_<?php echo $i ?>" data-table="destinations" data-changevalue="<?php echo @$change_to; ?>" data-column_name='status' data-wherecolumn="destination_id" data-wherevalue="<?php echo @$destination->destination_id; ?>" data-url="<?php echo route('toggleStatus'); ?>"  name="customSwitch" value="<?php echo @$testimonial->mark_as_testimonial ?>"/>
