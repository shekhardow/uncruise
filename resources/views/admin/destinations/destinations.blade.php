                                            ...
                                            <table id="myTable" class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                                                ...
                                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-td">
                                                            <a href="<?php echo url('admin/change-faq-status/' . $destination->destination_id . '/' . $change_to . '/destinations/destination_id/status'); ?>" status-type="<?php echo $change_to; ?>"
                                                        ...
                                                        <td class="table-td">
                                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                                ...
                                                                <a href="<?php echo url('admin/change-faq-status/'.$destination->destination_id.'/Deleted/destinations/destination_id/status'); ?>" class="status action-btn" data-tippy-content="Delete Destination" data-tippy-placement="top">
