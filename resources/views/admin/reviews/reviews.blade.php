                                            ...
                                            <table id="myTable" class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                                                <thead class=" bg-slate-200 dark:bg-slate-700">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="table-th">Mark as Testimonial</th>
                                                ...
                                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-td smallText"><?php echo !empty($review->review_type) ? $review->review_type : null; ?></td>
                                                        <td class="table-td">
                                                            <?php if($review->mark_as_testimonial == 'Testimonial'){ $class = "text-success-500 bg-success-500"; $status = "Testimonial"; $change_to = "No";
                                                            }else{ $class = "text-danger-500 bg-danger-500"; $status = "No"; $change_to = "Testimonial"; } ?>
                                                            <a href="<?php echo url('admin/change-status/' . $review->review_id . '/' . $change_to . '/reviews/review_id/mark_as_testimonial'); ?>" status-type="<?php echo $change_to; ?>"
