                            ...
                            <div class="card-body p-6">
                                <form method="post" id="submit-form" action="<?php echo !empty($ship_detail) ? route('admin/updateShip', ['id' => encryptionID($ship_detail->ship_id)]) : route('admin/addShip'); ?>" enctype="multipart/form-data">
                                    <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5 mb-3">
                                        ...
                                        <div class="form-group input-area">
                                            <label for="size & year" class="form-label">Size & Year (Ex: 174' Length, Decks 3 Gross Tonnage 354, Registry: St Kitts & Nevis, 54' Beam, 9 Knots, 10.3 Mph, Built 1982) :</label>
                                        ...
                                        <div class="form-group input-area">
                                            <label for="guest" class="form-label">Guest Info (Ex: 66 Guests, 34 Cabins, 100% Cabins  Outside, 4 triple Occupancy Cabins, 4 Balcony Cabins) :</label>
                                        ...
                                        <div class="form-group input-area">
                                            <label for="crew" class="form-label">Crew (Ex: 2.2:1 Guest-To-Crew Ratio, Crew: USA, Costa Rica, Panama, Belize, Mexico) :</label>
