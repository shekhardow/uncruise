                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-td">
                                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                                <a class="action-btn" href="<?php echo route('admin/adventureForm', ['id' => encryptionID($adventure->adventure_id)]); ?>" data-tippy-content="Edit Adventure" data-tippy-placement="top">
                                                                    <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                                                </a>
                                                                <a href="<?php echo url('admin/change-status/'.$adventure->adventure_id.'/Deleted/adventures/adventure_id/status'); ?>" class="status action-btn" data-tippy-content="Delete Adventure" data-tippy-placement="top">
