                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-td">
                                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                                <a class="action-btn" href="<?php echo route('admin/journeyForm', ['id' => encryptionID($journey->journey_id)]); ?>" data-tippy-content="Edit Adventure" data-tippy-placement="top">
                                                                    <iconify-icon icon="heroicons:pencil-square"></iconify-icon>
                                                                </a>
                                                                <a href="<?php echo url('admin/change-status/'.$journey->journey_id.'/Deleted/journeys/journey_id/status'); ?>" class="status action-btn" data-tippy-content="Delete Adventure" data-tippy-placement="top">
