                ...
                <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                    ...
                    <div class="auth-box2 flex flex-col justify-center h-full">
                        <div class="text-center 2xl:mb-10 mb-5">
                            ...
                            <h4 class="font-medium mb-4 signInHeading">Reset Your Password</h4>
                            <div class="text-slate-500 dark:text-slate-400 text-base">
                                Create new password and verify with OTP!
                            </div>
                        </div>
                        ...
                        <form class="space-y-4" id="common-form" action="<?php echo route('admin/doResetPassword'); ?>" method="POST">
                            ...
                            <button type="submit" id="submit-btn" class="btn btn-dark block w-full text-center">Reset Password</button>
                        </form>
